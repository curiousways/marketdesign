...
const Next = ({ onClick, hideButton }: Props) => {
  return (
    <button
      type="button"
      className={classNames(
        'w-10 h-10 bg-green-dark rounded-full flex justify-center items-center animate-scale-large hover:bg-green-extra-dark cursor-pointer',
