...
const Buyer = ({ buyer, stage, maxStage, options, className = "" }: Props) => {
  const { bid, discount, pays, products, title } = buyer;
  const {
    show_bids,
    show_surpluses,
    show_final_payments,
    show_buyer_products_details,
  } = options;
  return (
    <div
    ...
    >
      ...
      <div className="flex gap-x-10">
        ...
        <div className="h-[66px] w-[66px] neo-shadow-brown rounded-lg flex items-center justify-center relative">
          {stage >= show_buyer_products_details && (
